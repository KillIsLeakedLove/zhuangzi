...
<p>
  ...
  <img src="https://img.shields.io/badge/已上线-25篇-success?style=flat-square" alt="25篇">
...
本项目参照郭象注本《庄子》通行分类体系（内篇7、外篇15、杂篇11，共33篇），目前已上线 **25 篇**，剩余 **8 篇** 内容正在整理中。
...
4. **切换主题** — 点击右上角 🌙/☀️ 切换暗黑/明亮模式，支持自动适配系统偏好
